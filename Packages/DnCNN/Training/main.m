...
% scampi                                                                                                             
[X_scampi, D_scampi] = scampi_solver(yz, op, opTr, opSq, opSqTr, opt,isnr(i_snr)); % X_scampi is the reconstructed image, D_scampi, the estimation of the dual variables
