...
clear all
%Parameters
denoiser1='BLS-GSM';%Available options are NLM, Gauss, Bilateral, BLS-GSM, BM3D, fast-BM3D, BM3D-SAPCA, and DnCNN
denoiser2='DnCNN';
...
t0=tic;[x_hat1,psnr1(ii,:),mmse1(ii,:)]  = DAMP(y,AMP_iters,height,width,denoiser1,M,Mt,errfxn,MSEfxn);t1=toc(t0);
...
plot(10*log10(mmse1_ave),'.-','Displayname',[denoiser1,'-AMP-',num2str(n_DnCNN_layers)])
hold on; 
